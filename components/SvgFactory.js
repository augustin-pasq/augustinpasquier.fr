export default function SvgFactory(props) {
    return ({
        ...
        "mail":
            <svg fill="none" viewBox="0 0 32 23.27">
                <path d="M29.0909 0H2.90909C1.30244 0 0 1.30244 0 2.90909V20.3636C0 21.9703 1.30244 23.2727 2.90909 23.2727H29.0909C30.6976 23.2727 32 21.9703 32 20.3636V2.90909C32 1.30244 30.6976 0 29.0909 0Z"
        ...
        "mysql":
            <svg viewBox="43.88 40.13 224.04 152.15">
