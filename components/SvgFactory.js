export default function SvgFactory(props) {
    return ({
        ...
        "github":
            <svg viewBox="0 0 97.63 96" className="socials-item-icon">
        ...
        "linkedin":
            <svg viewBox="0 0 72 72" className="socials-item-icon">
        ...
        "mail":
            <svg fill="none" viewBox="0 0 32 23.27" className="socials-item-icon">
        ...
        "webstorm":
            <svg viewBox="4.5 4.5 96 96" className="tools-item-icon">
